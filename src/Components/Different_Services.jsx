...
function Different_Services() {
  return (
    <div className="mt-[100px] md:mt-[3vw] mb-10 w-[80vw] md:mb-[2vw] text-center mx-auto">
      ...
      {/* {OurServices.map((data, id) => console.log("hi " + data))} */}
      <div className="flex gap-[2vw] mb-[20px] md:justify-center justify-start  md:mb-[1vw] flex-wrap">
       
      {OurServices.map((data, id) => (
         <div key={id} className="card w-[100%] h-[90%] hover:bg-[#ff8a1d] hover:text-[#ffff]   p-[3vw] rounded-[10px] border md:h-[20vw] md:w-[30vw] lg:w-[25vw] lg:h-[15vw] bg-white flex flex-col gap-[20px] md:gap-[1vw] justify-center items-center shadow">
         <img
           src={data.img}
